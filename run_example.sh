...
--lora_weight_path ./models/StoryMem \
--size "832*480" --max_memory_size 10 \
--output_dir $OUTPUT_PATH \
--dit_fsdp --t5_fsdp --ulysses_size 8 --offload_model --lora_rank 128 --mm2v --t2v_first_shot
...
--size "832*480" --max_memory_size 10 \
--output_dir $OUTPUT_PATH \
--dit_fsdp --t5_fsdp --ulysses_size 8 --offload_model --lora_rank 128 --mm2v